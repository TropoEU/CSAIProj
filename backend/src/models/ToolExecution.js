...
export class ToolExecution {
     ...
     */
    static async create(conversationId, toolName, parameters, n8nResponse, success, executionTimeMs, status = null, errorReason = null) {
        ...
        const result = await db.query(
            `INSERT INTO tool_executions (conversation_id, tool_name, parameters, n8n_response, success, execution_time_ms, status, error_reason)
             ...
             RETURNING *`,
            [conversationId, toolName, parameters, n8nResponse, success, executionTimeMs, finalStatus, errorReason]
        );
