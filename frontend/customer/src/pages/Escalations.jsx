    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">{t('escalations.subtitle')}</p>
        </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <span
                        className={`px-2 py-1 text-xs rounded-full border ${getStatusColor(esc.status)}`}
                      >
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      {t('escalations.session')}:{' '}
                      <span className="font-mono text-xs">{esc.sessionId}</span>
                    </p>

                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                      <div>
                        <p className="text-gray-500">{t('escalations.escalatedAt')}</p>
                        <p className="font-medium text-gray-900">{formatDate(esc.escalatedAt)}</p>
                      </div>
                      {esc.acknowledgedAt && (
                        <div>
                      ...
                      {esc.resolvedAt && (
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{formatDate(esc.resolvedAt)}</p>
                        </div>
                      )}
                    </div>
                  </div>
