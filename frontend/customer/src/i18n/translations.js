...
export const translations = {
  en: {
    ...
    aiBehavior: {
      title: 'AI Behavior',
      subtitle: 'Customize how your AI assistant thinks and responds',
      guidedReasoning: 'Guided Reasoning',
      guidedReasoningDesc: 'Enable step-by-step reasoning process before responses',
      reasoningSteps: 'Reasoning Steps',
      reasoningStepsDesc: 'Define the steps the AI follows before responding',
      addStep: 'Add Step',
      stepTitle: 'Step title (e.g., UNDERSTAND)',
      stepInstruction: 'Instructions for this step...',
      ...
      toolRules: 'Tool Usage Rules',
      toolRulesDesc: 'Guidelines for when the AI should use tools',
      addRule: 'Add Rule',
      rulePlaceholder: 'Enter a tool usage rule...',
      customInstructions: 'Custom Instructions',
      customInstructionsDesc: 'Additional free-form instructions for the AI',
      customInstructionsPlaceholder: 'Add any custom instructions here...',
      resetToDefaults: 'Reset to Defaults',
      previewPrompt: 'Preview Prompt',
      saveChanges: 'Save Changes',
      resetConfirm: 'Reset AI behavior settings to defaults? This cannot be undone.',
      saveSuccess: 'AI behavior settings saved successfully!',
      saveError: 'Failed to save AI behavior settings',
      previewError: 'Failed to generate preview',
      resetSuccess: 'AI behavior settings reset to defaults',
      resetError: 'Failed to reset settings',
      hasCustomizations: 'You have customized these settings',
      usingDefaults: 'Using platform defaults',
    },
  ...
  he: {
    ...
    aiBehavior: {
      title: 'התנהגות AI',
      subtitle: 'התאם אישית את אופן החשיבה והתגובה של עוזר ה-AI שלך',
      guidedReasoning: 'חשיבה מודרכת',
      guidedReasoningDesc: 'הפעל תהליך חשיבה צעד אחר צעד לפני תגובות',
      reasoningSteps: 'שלבי חשיבה',
      reasoningStepsDesc: 'הגדר את הצעדים שה-AI עוקב אחריהם לפני שמגיב',
      addStep: 'הוסף שלב',
      stepTitle: 'כותרת שלב (לדוגמה: הבן)',
      stepInstruction: 'הוראות לשלב זה...',
      ...
      toolRules: 'כללי שימוש בכלים',
      toolRulesDesc: 'הנחיות מתי ה-AI צריך להשתמש בכלים',
      addRule: 'הוסף כלל',
      rulePlaceholder: 'הזן כלל שימוש בכלי...',
      customInstructions: 'הוראות מותאמות',
      customInstructionsDesc: 'הוראות נוספות חופשיות ל-AI',
      customInstructionsPlaceholder: 'הוסף הוראות מותאמות כאן...',
      resetToDefaults: 'אפס לברירת מחדל',
      previewPrompt: 'תצוגה מקדימה',
      saveChanges: 'שמור שינויים',
      resetConfirm: 'לאפס את הגדרות התנהגות ה-AI לברירת מחדל? לא ניתן לבטל פעולה זו.',
      saveSuccess: 'הגדרות התנהגות AI נשמרו בהצלחה!',
      saveError: 'שמירת הגדרות התנהגות AI נכשלה',
      previewError: 'יצירת תצוגה מקדימה נכשלה',
      resetSuccess: 'הגדרות התנהגות AI אופסו לברירת מחדל',
      resetError: 'איפוס ההגדרות נכשל',
      hasCustomizations: 'התאמת הגדרות אלו אישית',
      usingDefaults: 'משתמש בברירות מחדל של הפלטפורמה',
    },
